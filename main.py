...
# NOTE: Lots of commenting out b/c originally made for interactive command line modification.
# Default values have been given preference in this version.
# RECOMMENDED: Iterate multiple times to get phrases with long words. That's when the filter shines.
...
def placard():
    ...
    message_standard = ["RESIST", "HAVE EMPATHY", "QUESTION", "VOTE", "REDISTRIBUTE WEALTH", "GIVE MORE", "WASTE LESS",
                        "MIGHT ≠ RIGHT", "CONSUME LESS", "READ", "CHANGE IS POSSIBLE", "GIVE A SHIT"]
    # if message == "":
...
# if contrast == "":
contrast = 1.2  # increases contrast slightly (DEFAULT)
...
if W >= H:
    ...
    size_font = int(W / 4)  # Text adjusts to portrait mode accordingly
...
# placard = ' '.join(placard)  # https://docs.python.org/3/library/stdtypes.html#str.join
#
